			...
			<div className="grid h-screen place-content-center ">
				<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
					<svg
						...
						viewBox="0 0 512 512"
						className="w-40 h-40 text-rose-500">
						<path
							fill="currentColor"
				...
				<div className="text-center space-y-5">
					<p className="font-extrabold text-8xl  text-rose-500 animate-bounce">{error.status}</p>

					<h1 className="text-2xl font-bold tracking-tight text-rose-500 sm:text-4xl">
					...
					<Link
						...
						<span className="absolute inset-0 translate-x-0 translate-y-0 bg-gradient-to-r from-slate-900 via-rose-900 to-slate-900 transition-transform group-hover:translate-y-1.5 group-hover:translate-x-1.5"></span>
